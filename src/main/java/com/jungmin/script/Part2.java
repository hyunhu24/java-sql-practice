...
public class Part2 {
  ...
  */
  public static final String PART2_3 = "insert into users (username, email, password) " +
          "values ('hyunhu','gusgn@test.com','test1234')";
  ...
  */
  public static final String PART2_4 = "select * from users as u " +
  ...
  */
  public static final String PART2_5 = "select * from users as u " +
          "where not u.username = 'luckykim'";
  ...
  */
  public static final String PART2_7 = "select p.title, u.username from users as u " +
  ...
  */
  public static final String PART2_8 = "select p.title, u.username from users as u " +
          "join posts as p " +
          "on p.user_id = u.user_id;";
  ...
  */
  public static final String PART2_10 = "insert into posts (title, content, user_id, board_id, created_at) " +
          "values ('test','test content', 1 , 1 , '2024-12-16');";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 2-11. 어느 board에도 속하지 않는 post의 모든 데이터를 찾기위한 SQL을 작성해주세요.")
  */
  public static final String PART2_11 = "select * from posts as p " +
  ...
  */
  public static final String PART2_13 = "select b.name from boards as b " +
          "join posts as p on p.board_id = b.board_id " +
          "where p.user_id = 1";
  ...
  */
  public static final String PART2_15 =
          "select count(c.comment_id) as CommentCount from comments as c " +
  ...
  */
  public static final String PART2_16 = "select u.user_id, count(c.comment_id) as CommentCount " +
          "from users as u " +
  ...
  */
  public static final String PART2_17 = "select b.name, count(p.board_id) as PostCount " +
          "from posts as p " +
          "join boards as b on p.board_id = b.board_id " +
          "group by b.name";
  ...
  */
  public static final String PART2_18 = "select b.name, AVG(length(p.content)) as AvgLength " +
          "from posts as p " +
          "right join boards as b on p.board_id = b.board_id " +
          "group by b.name";
